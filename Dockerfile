...
RUN pip3 install numpy==1.14.0 sklearn typing pytest flask pandas flask-cors scipy pytest-cov Flask-Session graphviz cryptography==2.1.4 flask-ask neo4j-driver
